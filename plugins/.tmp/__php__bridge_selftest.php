...
$c = trim((string)($in['content'] ?? ''));
if ($c === 'v') echo json_encode(array('replies' => array(array('type' => 'voice', 'voiceUrl' => 'https://example.com/a.mp3', 'fileName' => 'a.mp3'))));
elseif ($c === 'r') echo json_encode(array('replies' => array(array('type' => 'recall', 'messageId' => 'MSG9', 'hideTip' => true))));
elseif ($c === 'd') echo json_encode(array('replies' => array(array('type' => 'dashboard'))));
elseif ($c === 'm') echo json_encode(array('replies' => array(array('type' => 'markdown', 'content' => '**m** [x](https://qq.com)'))));
elseif ($c === 'msgType') echo json_encode(array('replies' => array(array('type' => 'group', 'content' => '旧协议文本', 'msgType' => 'markdown'))));
else echo json_encode(array('replies' => array()));
