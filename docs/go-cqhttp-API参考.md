...
commented
on May 3, 2021
啊这 好像还有点问题。QueryEscape()把空格编码成+了，QQ那边不识别，我再去MiraiGo那改改（

@MikeWang000000
MikeWang000000 marked this pull request as draft 5 years ago
@MikeWang000000
Update MiraiGo
9a9736f
MikeWang000000
...
model	"go-cqhttp"
{
    "data": {
        "variants": [
            ...
            {
                "model_show": "go-cqhttp (白色)",
                "need_pay": false
            },
            {
                "model_show": "go-cqhttp (银色)",
                "need_pay": false
            },
            {
                "model_show": "go-cqhttp (灰色)",
                "need_pay": false
            },
            {
                "model_show": "go-cqhttp (金色)",
                "need_pay": false
            },
            {
                "model_show": "go-cqhttp",
                "need_pay": true
            }
        ]
    },
...
Apple系列的除了Watch都是按照Apple的命名方式取的。

另外，Android Watch等协议登录时好像修改不了。虽然返回成功也有设置不了的情况。

@MikeWang000000
MikeWang000000 marked this pull request as ready for review 5 years ago
MikeWang000000
commented
on May 3, 2021
(￣∇￣)哈哈
还有一点，_set_model_show里面model_show参数为空""的时候，恢复初始状态如手机在线等。

wdvxdr1123
wdvxdr1123 approved these changes on May 4, 2021
@wdvxdr1123
wdvxdr1123 merged commit 66017bf into Mrs4s:dev on May 4, 2021
zjkwdy
commented
on Jun 6, 2021
Screenshot_20210606_124258_com tencent mobileqq
黑色高级手机🌚

@wdvxdr1123 wdvxdr1123 mentioned this pull request on Aug 15, 2021
Doc: write v1.0.0 document. #1009
Open
7 tasks
yucho123987
commented
on Jan 21, 2023
Screenshot_20210606_124258_com tencent mobileqq 黑色高级手机🌚
...
请问该功能现在还能使用吗？我分别使用了Android Phone 和 iPad 协议，虽然返回成功但也设置不了。
